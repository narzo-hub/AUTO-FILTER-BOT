...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for x in filesarr:
            await x.delete()
        await k.edit_text("<b>‼️ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ‼️</b>")
        return
    ...
    if data.startswith("sendfiles"):
        ...
        await k.edit("<b>‼️ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ‼️</b>")
        return
    ...
    await asyncio.sleep(600)
    await msg.delete()
    await k.edit_text("<b>‼️ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴀɢᴀɪɴ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ‼️</b>",reply_markup=InlineKeyboardMarkup(btn))
    return   
...
async def delete(bot, message):
    ...
    file_id, file_ref, *other_values = unpack_new_file_id(media.file_id)
